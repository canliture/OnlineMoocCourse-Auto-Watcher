...
- __2020.4.7 增加 `就业指导—蒋磊` 章节测试`参考答案`以及刷题JavaScript`代码`__

`说明：如果您有其它网课的答案，并且愿意分享出来帮助更多的人，那么你可以邮件联系我。我会定制相应的刷题代码，共享出来。`
...
- **最后，觉得我的内容不错，可以`Star一下呗！或者打赏一下^_^`**

![](./images/GitMeACuptOfMilkCofffe.png)
...
章节测试题的代码链接，在**项目目录**文件[`/章节测试题代码/`](./创业基础—胡石其—章节测试题代码)下，可以自行赋值粘贴并运行。代码的作用就是直接帮你填答案，省的手动填了，节省了很多时间。
